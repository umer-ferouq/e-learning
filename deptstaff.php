...
?>
  ...
  <div class="container">
             ...
             <div class="col-sm-4 col-md-4"></div>
               <div class=""><h3>Department Staff</h3></div>
        ...
        <?php
          $selquery ="SELECT `staff_id`, `staff_name`, `staff_number`, `email`, `phone`, `role`, `dpt_id`, `gender`,`dept_name` FROM `staff` INNER JOIN dept ON
           staff.dpt_id = dept_id WHERE dept_name = 'computer science'";
